...
@CucumberOptions(
    ...
    tags = "not @OpenKeyDoorLockInOfflineModeAndroidApp and not @LoginToHostPortal and not @SessionCreateInHostPortal and not @SessionDeleteInHostPortal and not @SessionDeletedScenarioInApp",
